# 8020REI Knowledge Baseline

A simple static review page with 50 English questions, optional per-question and overall feedback, and copy/download controls.

Open `index.html` or serve this directory with any static server. The site needs no build, account, database or backend. GitHub Pages publishes the `site` branch root.
